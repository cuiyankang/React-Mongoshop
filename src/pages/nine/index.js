                ...
                <div className="freeShipping">
                    ...
                    <div className="centerAll">
                        ...
                        <div className="recommend">
                            ...
                            <ul>
                                <li>
                                    <img className="recommendTopImg" src="https://img.alicdn.com/imgextra/i4/717309111/O1CN01DlheRm2HAt5dRzF6v_!!717309111.jpg_310x310.jpg_.webp" alt=""/>
                                    <div className="recommendBottom">
                                        <div className="recommendBottomT">
                                            <img src="./img/tmall.gif" alt=""/>
                                            <div className="details">【222片】双面3层加厚卸妆化妆棉</div>
                                        </div>
                                        ...
                                        <div className="coupon"><span>券</span>1元</div>
